...
VALUES (48931,   1,      16) /* ItemType - Creature */
     ...
     , (48931,   3,      61) /* PaletteTemplate - White */
...
VALUES (48931,   1,                5) /* HeartbeatInterval */
     ...
     , (48931,  15,                1) /* ArmorModVsBludgeon */
     , (48931,  16,                1) /* ArmorModVsCold */
     , (48931,  17,                1) /* ArmorModVsFire */
     , (48931,  18,                1) /* ArmorModVsAcid */
     , (48931,  19,                1) /* ArmorModVsElectric */
     , (48931,  31,               17) /* VisualAwarenessRange */
     , (48931,  34,              2.3) /* PowerupTime */
     , (48931,  39, 1.20000004768372) /* DefaultScale */
     , (48931,  64,                1) /* ResistSlash */
     , (48931,  65,                1) /* ResistPierce */
     , (48931,  66,                1) /* ResistBludgeon */
     , (48931,  67,                1) /* ResistFire */
     , (48931,  68,                1) /* ResistCold */
     , (48931,  69,                1) /* ResistAcid */
     , (48931,  70,                1) /* ResistElectric */
     , (48931,  80,                3) /* AiUseMagicDelay */
...
VALUES (48931,  1,  33554433) /* Setup */
     ...
     , (48931,  4, 805306376) /* CombatTable */
     , (48931,  6,  67108990) /* PaletteBase */
     , (48931,  7, 268435983) /* ClothingBase */
...
VALUES (48931,  0,  4,  0,    0,  350,  277,  315,  350,  294,  294,  294,  294,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (48931,  1,  4,  0,    0,  350,  277,  315,  350,  294,  294,  294,  294,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (48931,  2,  4,  0,    0,  350,  277,  315,  350,  294,  294,  294,  294,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (48931,  3,  4,  0,    0,  350,  277,  315,  350,  294,  294,  294,  294,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (48931,  4,  4,  0,    0,  350,  277,  315,  350,  294,  294,  294,  294,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (48931,  5,  4, 90, 0.75,  350,  277,  315,  350,  294,  294,  294,  294,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (48931,  6,  4,  0,    0,  350,  277,  315,  350,  294,  294,  294,  294,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (48931,  7,  4,  0,    0,  350,  277,  315,  350,  294,  294,  294,  294,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (48931,  8,  4, 90, 0.75,  350,  277,  315,  350,  294,  294,  294,  294,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (48931, 2, 46604,  1, 0, 0, False) /* Create  (46604) for Wield */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (48931,  31, 0, 2, 0, 149, 0, 0) /* CreatureMagic */
     , (48931,  46, 0, 2, 0, 663, 0, 0) /* FinesseWeapons */
     , (48931,  44, 0, 2, 0, 663, 0, 0) /* HeavyWeapons */
     , (48931,  33, 0, 2, 0, 149, 0, 0) /* LifeMagic */
     , (48931,  45, 0, 2, 0, 663, 0, 0) /* LightWeapons */
     , (48931,  15, 0, 2, 0, 170, 0, 0) /* MagicDefense */
     , (48931,  16, 0, 2, 0, 149, 0, 0) /* ManaConversion */
     , (48931,  6, 0, 2, 0, 702, 0, 0) /* MeleeDefense */
     , (48931,  7, 0, 2, 0, 149, 0, 0) /* MissileDefense */
     , (48931,  41, 0, 2, 0, 663, 0, 0) /* TwoHanded */
     , (48931,  43, 0, 2, 0, 149, 0, 0) /* VoidMagic */
     , (48931,  34, 0, 2, 0, 149, 0, 0) /* WarMagic */;
