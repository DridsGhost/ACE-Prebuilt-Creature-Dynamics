...
VALUES (46516,   1,      16) /* ItemType - Creature */
     ...
     , (46516, 146, 1850000) /* XpOverride */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (46516,   1, True ) /* Stuck */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (46516,  13,  1) /* ArmorModVsSlash */
     , (46516,  14,  1) /* ArmorModVsPierce */
     , (46516,  15,  1) /* ArmorModVsBludgeon */
     , (46516,  16,  1) /* ArmorModVsCold */
     , (46516,  17,  1) /* ArmorModVsFire */
     ...
     , (46516,  64,  1) /* ResistSlash */
     , (46516,  65,  1) /* ResistPierce */
     , (46516,  66,  1) /* ResistBludgeon */
     , (46516,  67,  1) /* ResistFire */
     , (46516,  68,  1) /* ResistCold */
     , (46516,  69,  1) /* ResistAcid */
     , (46516,  70,  1) /* ResistElectric */
...
VALUES (46516,   1,  50, 0, 0) /* Strength */
     , (46516,   2,  50, 0, 0) /* Endurance */
     , (46516,   3,  50, 0, 0) /* Quickness */
     , (46516,   4,  50, 0, 0) /* Coordination */
     , (46516,   5,  50, 0, 0) /* Focus */
     , (46516,   6,  30, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (46516,   1,     0, 0, 0, 2850) /* MaxHealth */
     , (46516,   3,    50, 0, 0, 50) /* MaxStamina */
     , (46516,   5,    30, 0, 0, 30) /* MaxMana */;
...
VALUES (46516,  0,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (46516,  5,  4, 600, 0.75,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (46516,  8,  4, 600, 0.75,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (46516, 2, 46367,  1, 0, 0, False) /* Create  (46367) for Wield */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (46516,  31, 0, 2, 0, 149, 0, 0) /* CreatureMagic */
     , (46516,  46, 0, 2, 0, 687, 0, 0) /* FinesseWeapons */
     , (46516,  44, 0, 2, 0, 687, 0, 0) /* HeavyWeapons */
     , (46516,  33, 0, 2, 0, 149, 0, 0) /* LifeMagic */
     , (46516,  45, 0, 2, 0, 687, 0, 0) /* LightWeapons */
     , (46516,  15, 0, 2, 0, 170, 0, 0) /* MagicDefense */
     , (46516,  16, 0, 2, 0, 149, 0, 0) /* ManaConversion */
     , (46516,  6, 0, 2, 0, 525, 0, 0) /* MeleeDefense */
     , (46516,  7, 0, 2, 0, 149, 0, 0) /* MissileDefense */
     , (46516,  41, 0, 2, 0, 687, 0, 0) /* TwoHanded */
     , (46516,  43, 0, 2, 0, 149, 0, 0) /* VoidMagic */
     , (46516,  34, 0, 2, 0, 149, 0, 0) /* WarMagic */;
