...
VALUES (38844,   1,      16) /* ItemType - Creature */
     ...
     , (38844,   3,       9) /* PaletteTemplate - Grey */
...
VALUES (38844,   1,  5) /* HeartbeatInterval */
     ...
     , (38844,   5,  1) /* ManaRate */
     , (38844,  13,  1) /* ArmorModVsSlash */
     , (38844,  14,  1) /* ArmorModVsPierce */
     , (38844,  15,  1) /* ArmorModVsBludgeon */
     , (38844,  16,  1) /* ArmorModVsCold */
     , (38844,  17,  1) /* ArmorModVsFire */
     , (38844,  18,  1) /* ArmorModVsAcid */
     , (38844,  19,  1) /* ArmorModVsElectric */
     , (38844,  31, 18) /* VisualAwarenessRange */
     , (38844,  64,  1) /* ResistSlash */
     , (38844,  65,  1) /* ResistPierce */
     , (38844,  66,  1) /* ResistBludgeon */
     , (38844,  67,  1) /* ResistFire */
     , (38844,  68,  1) /* ResistCold */
     , (38844,  69,  1) /* ResistAcid */
     , (38844,  70,  1) /* ResistElectric */
...
VALUES (38844,  1,  33554510) /* Setup */
     ...
     , (38844,  7, 268437191) /* ClothingBase */
...
VALUES (38844,  0,  4,  0,    0,  250,  225,  250,  275,  100,  100,  250,  150,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (38844,  1,  4,  0,    0,  250,  225,  250,  275,  100,  100,  250,  150,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (38844,  2,  4,  0,    0,  250,  225,  250,  275,  100,  100,  250,  150,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (38844,  3,  4,  0,    0,  250,  225,  250,  275,  100,  100,  250,  150,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (38844,  4,  4,  0,    0,  250,  225,  250,  275,  100,  100,  250,  150,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (38844,  5,  4,  4, 0.75,  250,  225,  250,  275,  100,  100,  250,  150,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (38844,  6,  4,  0,    0,  250,  225,  250,  275,  100,  100,  250,  150,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (38844,  7,  4,  0,    0,  250,  225,  250,  275,  100,  100,  250,  150,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (38844,  8,  4,  8, 0.75,  250,  225,  250,  275,  100,  100,  250,  150,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (38844,  2074,   2.02)  /* Gossamer Flesh */
     ...
     , (38844,  4635,   2.02)  /* Incantation of War Magic Ineptitude Other */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (38844, 2, 38850,  1, 0, 0, False) /* Create  (38850) for Wield */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (38844,  31, 0, 2, 0, 149, 0, 0) /* CreatureMagic */
     , (38844,  46, 0, 2, 0, 132, 0, 0) /* FinesseWeapons */
     , (38844,  44, 0, 2, 0, 132, 0, 0) /* HeavyWeapons */
     , (38844,  33, 0, 2, 0, 149, 0, 0) /* LifeMagic */
     , (38844,  45, 0, 2, 0, 132, 0, 0) /* LightWeapons */
     , (38844,  15, 0, 2, 0, 170, 0, 0) /* MagicDefense */
     , (38844,  16, 0, 2, 0, 149, 0, 0) /* ManaConversion */
     , (38844,  6, 0, 2, 0, 635, 0, 0) /* MeleeDefense */
     , (38844,  7, 0, 2, 0, 149, 0, 0) /* MissileDefense */
     , (38844,  41, 0, 2, 0, 132, 0, 0) /* TwoHanded */
     , (38844,  43, 0, 2, 0, 149, 0, 0) /* VoidMagic */
     , (38844,  34, 0, 2, 0, 149, 0, 0) /* WarMagic */;
