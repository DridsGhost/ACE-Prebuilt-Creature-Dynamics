...
VALUES (46515,  13,  1) /* ArmorModVsSlash */
     , (46515,  14,  1) /* ArmorModVsPierce */
     , (46515,  15,  1) /* ArmorModVsBludgeon */
     , (46515,  16,  1) /* ArmorModVsCold */
     ...
     , (46515,  64,  1) /* ResistSlash */
     , (46515,  65,  1) /* ResistPierce */
     , (46515,  66,  1) /* ResistBludgeon */
     , (46515,  67,  1) /* ResistFire */
     , (46515,  68,  1) /* ResistCold */
     , (46515,  69,  1) /* ResistAcid */
     , (46515,  70,  1) /* ResistElectric */
...
VALUES (46515,  0,  4,  0,    0,  400,  275,  275,  225,  250,  400,  225,  400,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (46515,  5,  4, 600, 0.75,  400,  275,  275,  225,  250,  400,  225,  400,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (46515,  8,  4, 600, 0.75,  400,  275,  275,  225,  250,  400,  225,  400,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (46515, 2, 46366,  1, 0, 0, False) /* Create  (46366) for Wield */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (46515,  31, 0, 2, 0, 149, 0, 0) /* CreatureMagic */
     , (46515,  46, 0, 2, 0, 687, 0, 0) /* FinesseWeapons */
     , (46515,  44, 0, 2, 0, 687, 0, 0) /* HeavyWeapons */
     , (46515,  33, 0, 2, 0, 149, 0, 0) /* LifeMagic */
     , (46515,  45, 0, 2, 0, 687, 0, 0) /* LightWeapons */
     , (46515,  15, 0, 2, 0, 170, 0, 0) /* MagicDefense */
     , (46515,  16, 0, 2, 0, 149, 0, 0) /* ManaConversion */
     , (46515,  6, 0, 2, 0, 525, 0, 0) /* MeleeDefense */
     , (46515,  7, 0, 2, 0, 149, 0, 0) /* MissileDefense */
     , (46515,  41, 0, 2, 0, 687, 0, 0) /* TwoHanded */
     , (46515,  43, 0, 2, 0, 149, 0, 0) /* VoidMagic */
     , (46515,  34, 0, 2, 0, 149, 0, 0) /* WarMagic */;
